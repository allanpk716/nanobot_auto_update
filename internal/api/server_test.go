...
func TestNewServer(t *testing.T) {
	...
	server, err := NewServer(cfg, im, fullCfg, "test-version", logger, nil)
	if err != nil {
...
func TestNewServerValidation(t *testing.T) {
	...
	_, err := NewServer(nil, im, fullCfg, "test-version", logger, nil)
	if err == nil {
	...
	_, err = NewServer(cfg, im, fullCfg, "test-version", logger, nil)
	if err == nil {
