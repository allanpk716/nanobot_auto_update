...
<verify>
  <automated>go test -v ./internal/lifecycle -run TestStartNanobotWithCapture -timeout 15s</automated>
</verify>
<done>
  ...
  - `go test -v ./internal/lifecycle -run TestStartNanobotWithCapture -timeout 15s` 通过
</done>
</task>
...
<verification>
运行 `go test -v ./internal/lifecycle -run TestStartNanobotWithCapture -timeout 15s` 验证:
