# Requirements Archive: v0.4 实时日志查看
...
- [x] **CAPT-01**: 系统捕获 nanobot 进程的 stdout 输出流
- [x] **CAPT-02**: 系统捕获 nanobot 进程的 stderr 输出流
- [x] **CAPT-03**: 系统并发读取 stdout 和 stderr 管道，防止管道缓冲区满导致死锁
