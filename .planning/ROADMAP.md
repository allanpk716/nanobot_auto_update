...
- [x] **Phase 20: Log Capture Integration** - 捕获 nanobot 进程的 stdout/stderr 输出 (completed 2026-03-17)
...
Plans:
- [ ] 20-01-PLAN.md — 实现 captureLogs 核心函数 (CAPT-01, CAPT-02, CAPT-03)
- [ ] 20-02-PLAN.md — 实现 StartNanobotWithCapture 函数 (CAPT-04, CAPT-05)
